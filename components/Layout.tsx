...
export const Layout: React.FC<LayoutProps> = ({ 
  children, currentLang, setLang, theme, toggleTheme, currentPage, setPage, user
}) => {
  ...
  const Icons = {
    ...
    Tournaments: <svg width="20" height="20" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M6 9l6 6 6-6"/></svg>, // Simplified trophy
